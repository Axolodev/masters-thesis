...
\parencite{digitalization-generalBenefits-uberbacher2020} reports how 22 family
SMEs from the north of Italy have seen improvements in areas such as
communication and sense of togetherness, logistics, work
organization, time saving, among others. However, these companies saw
disadvantages in areas related to IT security, employee competencies,
and high investment costs.

\parencite{digitalization-generalBenefits-nitsch-etal} found that digitalization
supports businesses with financial and time savings. Additionally, it can open
sales opportunities by becoming more attractive for younger skilled workers. In
addition, it can also help them be more innovative by creating more services
that can be offered along with their products. This not only helps
them by creating more value for their customers, but also by setting themselves
apart from their competitors.

\parencite{digitalization-generalBenefits-2016}
...
\parencite{digitalization-generalBenefits-2020} Benefits: -
...
While it is important to show the benefits that digitalization has for
crafts SMEs, it is of equal importance to highlight that this change also has
its drawbacks.

According to \parencite{digitalization-four-core-dimensions}, a full digital
transformation strategy should cover changes in (1) Value creation,
(2) Use of digital technologies, (3) New structural changes, and (4) A positive
impact in financial aspects. However, due to its visible effect in environment
and sustainability-related \acrshort{sdg}s, an argument can be made to also
include these as additional dimensions in a complete strategy.
